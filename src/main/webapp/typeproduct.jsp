        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="product1.jsp">Cửa hàng</a></li>
                    <li class="breadcrumb-item "><a class="disabled-link" href="">Quả</a></li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="col-9">
                <div class="row justify-content-center mb-3 pb-3">
                    <div class="col-md-12 heading-section text-center ftco-animate">
                        ...
                        <h2 class="title">Quả</h2>
                        <%--                <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>--%>
                    </div>
                </div>
                <div class="selectboot">
                    <select class="browser-default custom-select">
                        <option selected>Bộ lọc sản phẩm</option>
                        <option value="1">Theo giá</option>
                        <option value="2">Theo bảng chữ cái</option>
                ...
                <section>
                    ...
                    <%--          <li><a href="#" class="filter__bar active">All</a></li>--%>
                    <%--          <li><a href="#" class="filter__bar">Vegetables</a></li>--%>
                    <%--          <li><a href="#" class="filter__bar">Fruits</a></li>--%>
                    <%--          <li><a href="#" class="filter__bar">Juice</a></li>--%>
                    <%--          <li><a href="#" class="filter__bar">Dried</a></li>--%>
                    <%--        </ul>--%>
                    <%--      </div>--%>
                    <%--    </div>--%>
                    ...
                    <div>
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-3 ftco-animate">
                                <div class="product">
                                    ...
                                    <div class="text py-3 pb-4 px-3 text-center">
                                        ...
                                        <div class="d-flex">
                                            <div class="pricing">
                                                <p class="price"><span>39.000 VND</span></p>
                                            </div>
                                        </div>
                                        <div class="bottom-area d-flex px-3">
                                            <div class="m-auto d-flex">
                            ...
                            <div class="col-md-6 col-lg-3 ftco-animate">
                                <div class="product">
                                    ...
                                    <div class="text py-3 pb-4 px-3 text-center">
                                        ...
                                        <div class="d-flex">
                                            <div class="pricing">
                                                <p class="price"><span>22.000 VND</span></p>
                                            </div>
                                        </div>
                                        <div class="bottom-area d-flex px-3">
                                            <div class="m-auto d-flex">
                            ...
                            <div class="col-md-6 col-lg-3 ftco-animate">
                                <div class="product">
                                    <a href="#" class="img-prod"><img class="img-fluid" src="images/qua/khe.png"
                                                                      alt="Colorlib Template">
                                        <%--                        <span class="status">50%</span>--%>
                                        <div class="overlay"></div>
                                    </a>
                            ...
                            <div class="col-md-6 col-lg-3 ftco-animate">
                                <div class="product">
                                    <a href="#" class="img-prod"><img class="img-fluid" src="images/qua/duahau.jpg"
                                                                      alt="Colorlib Template">
                                        <div class="overlay"></div>
                                    </a>
                                    <div class="text py-3 pb-4 px-3 text-center">
