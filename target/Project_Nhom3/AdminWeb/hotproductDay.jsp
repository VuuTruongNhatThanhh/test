...
<section class="home-section">
  <div class="home-content">
    <div class="manager-product">
      <div class="title">Sản Phẩm Bán Chạy Trong Ngày</div>
      <div class="row">
        <div class="col-md-12">
          ...
          <table id="table-id" class="table table-hover table-bordered">
            ...
            <tr>
              ...
              <th scope="col">Số lượng bán trong ngày</th>
            </tr>
            </thead>
            <tbody>
            <c:forEach items="${hotD}" begin="0" end="10" var="hotD">
              <tr id="${hotD.name}">
                <th scope="row">${hotD.name}</th>
                <td>${hotD.getAmmount()}</td>
              </tr>
            </c:forEach>
            </tbody>
          </table>
