...
<section class="home-section">
    <div class="home-content">
        <div class="manager-product">
            <div class="title">Sản Phẩm Bán Chạy Trong Tháng</div>
            <div class="row">
                <div class="col-md-12">
                    ...
                    <table id="table-id" class="table table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <th scope="col">Số lượng bán trong năm</th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:forEach items="${hotM}" begin="0" end="10" var="hotM">
                            <tr id="${hotM.name}">
                                <th scope="row">${hotM.name}</th>
                                <td>${hotM.getAmmount()}</td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    </table>
